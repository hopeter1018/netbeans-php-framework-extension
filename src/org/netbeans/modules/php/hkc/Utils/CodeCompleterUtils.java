...
import org.netbeans.modules.php.hkc.UserAccessControl.AnnotationCompleter;
...
//    }
    ...
    public static Map<String, PhpClassFile> getAllPhpWithAnnotations(Project editingProject, String... toFindAnnotations) {
        List<FileObject> phpFiles = ProjectUtils.findByMimeType(editingProject, CommonConstants.NB_MIME_PHP);
    ...
    public static String getLastDocBlockByOffset(FileObject fileObject, int offset) throws IOException
    {
        if (fileObject != null) {
            ...
            if (text.lastIndexOf("/*") > 0 && text.lastIndexOf("*/") > 0 && text.lastIndexOf("*/") > text.lastIndexOf("/*")) {
